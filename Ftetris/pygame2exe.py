...
class BuildExe:
    def __init__(self):
        ...
        # 游戏名
        self.project_name = "Funny Tetris"
        # 游戏site
        self.project_url = "http://eyehere.net/2011/python-pygame-novice-professional-index/"
        # 游戏版本
